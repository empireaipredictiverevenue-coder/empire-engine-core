...
Placeholder. Ugly-Banner ad campaign generator (visual ads for direct mail / display / video). Not yet wired.
...
# Run the agent
cd /root/empire-v49
/usr/bin/python3 -m agents.ugly_banner 2>&1 | tail -20
```
