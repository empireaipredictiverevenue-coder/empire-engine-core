...
INSERT INTO product_pricing (product_slug, tier, mrr_usd, checks_per_month, brief_enabled, alerts_enabled)
VALUES
...
VALUES
    ('sub_demo_market_eye_starter',   'demo_market_eye_starter',   'MARKET_EYE_STARTER',    199.00, 1, NOW() + INTERVAL '30 days', 'Demo — Market Eye Starter'),
    ('sub_demo_market_eye_growth',    'demo_market_eye_growth',    'MARKET_EYE_GROWTH',     499.00, 1, NOW() + INTERVAL '30 days', 'Demo — Market Eye Growth'),
    ('sub_demo_market_eye_enterprise','demo_market_eye_enterprise','MARKET_EYE_ENTERPRISE', 999.00, 15,NOW() + INTERVAL '30 days', 'Demo — Market Eye Enterprise')
ON CONFLICT (subscription_id) DO NOTHING;

-- ── 4. Demo feature flags ────────────────────────────────────────────────────
INSERT INTO product_feature_flags (customer_account_id, market_eye_enabled, market_eye_max_checks, market_eye_brief_enabled, market_eye_alerts_enabled)
VALUES
