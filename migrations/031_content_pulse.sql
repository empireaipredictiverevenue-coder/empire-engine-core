...
-- ── 2. product_pricing ───────────────────────────────────────────────────────
INSERT OR IGNORE INTO product_pricing (product_slug, tier, mrr_usd, checks_per_month, landing_pages_enabled, bulk_enabled)
VALUES
...
VALUES
    ('sub_demo_content_starter',   'demo_content_starter',   'CONTENT_PULSE_STARTER',   99.00,  1, datetime('now', '+30 days'), 'Demo — Content Pulse Starter'),
    ('sub_demo_content_growth',    'demo_content_growth',    'CONTENT_PULSE_GROWTH',    249.00, 1, datetime('now', '+30 days'), 'Demo — Content Pulse Growth'),
    ('sub_demo_content_enterprise','demo_content_enterprise','CONTENT_PULSE_ENTERPRISE',499.00, 15,datetime('now', '+30 days'), 'Demo — Content Pulse Enterprise');

-- ── 4. Demo feature flags ────────────────────────────────────────────────────
INSERT OR IGNORE INTO product_feature_flags (customer_account_id, content_pulse_enabled, content_pulse_max_checks, content_pulse_landing_pages_enabled, content_pulse_bulk_enabled)
VALUES
